...
CREATE TABLE `Address` ( `addressId` VARCHAR(64) NOT NULL, `addressTypeId` VARCHAR(64) NOT NULL, `addressLabel` VARCHAR(11) NULL DEFAULT NULL, `address1` VARCHAR(256) NULL DEFAULT NULL, `address2` VARCHAR(256) NULL DEFAULT NULL, `address3` VARCHAR(256) NULL DEFAULT NULL, `countryId` VARCHAR(64) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `cityId` VARCHAR(64) NOT NULL, `zipcode` VARCHAR(6) NOT NULL, `latitude` VARCHAR(64) NULL DEFAULT NULL, `longitude` VARCHAR(64) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`addressId`));
...
CREATE TABLE `EmailCommunication` ( `emailCommId` VARCHAR(256) NOT NULL, `commType` VARCHAR(256) NOT NULL, `email` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`emailCommId`));

DROP TABLE IF EXISTS `PhoneCommunication`;

CREATE TABLE `PhoneCommunication` ( `phoneId` VARCHAR(256) NOT NULL, `commType` VARCHAR(256) NOT NULL, `phoneNo` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`phoneId`));

DROP TABLE IF EXISTS `SocialCommunication`;

CREATE TABLE `SocialCommunication` ( `socialId` VARCHAR(256) NOT NULL, `commType` VARCHAR(256) NOT NULL, `social` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`socialId`));
...
CREATE TABLE `UserDetail` ( `userId` VARCHAR(64) NOT NULL, `userAccessCode` INT(11) NULL DEFAULT NULL, `userAccessLevelId` VARCHAR(64) NULL DEFAULT NULL, `userAccessDomainId` VARCHAR(64) NULL DEFAULT NULL, `multiFactorAuthEnabled` INT(1) NULL DEFAULT NULL, `genTempOneTimePassword` INT(1) NULL DEFAULT NULL, `allowMultipleLogin` INT(1) NULL DEFAULT NULL, `isLocked` INT(1) NULL DEFAULT NULL, `isDeleted` INT(1) NULL DEFAULT NULL, `changePasswordNextLogin` INT(1) NULL DEFAULT NULL, `passwordExpiryDate` TIMESTAMP NULL DEFAULT NULL, `passwordAlgo` VARCHAR(64) NULL DEFAULT '1', `lastPasswordChangeDate` TIMESTAMP NULL DEFAULT NULL, `sessionTimeout` INT(11) NULL DEFAULT '1800', `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`userId`));

DROP TABLE IF EXISTS `Login`;

CREATE TABLE `Login` ( `loginPk` VARCHAR(64) NOT NULL, `loginId` VARCHAR(200) NOT NULL, `serverAuthImage` VARCHAR(64) NULL DEFAULT NULL, `serverAuthText` VARCHAR(32) NULL DEFAULT NULL, `userId` VARCHAR(64) NOT NULL, `contactId` VARCHAR(64) NOT NULL, `failedLoginAttempts` INT(11) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`loginPk`));

DROP TABLE IF EXISTS `LoginSession`;

CREATE TABLE `LoginSession` ( `AppSessionId` VARCHAR(256) NOT NULL, `userId` VARCHAR(64) NOT NULL, `AppServerSessionId` VARCHAR(256) NOT NULL, `loginTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `lastAccessTime` TIMESTAMP NULL DEFAULT NULL, `logoutTime` TIMESTAMP NULL, `clientIPAddress` VARCHAR(128) NOT NULL, `clientIPAddressInt` BIGINT NULL DEFAULT NULL, `clientNetworkAddress` INT(11) NULL DEFAULT NULL, `clientBrowser` VARCHAR(256) NOT NULL, `sessionData` TEXT NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`AppSessionId`));

DROP TABLE IF EXISTS `PassRecovery`;

CREATE TABLE `PassRecovery` ( `passRecoveryId` VARCHAR(64) NOT NULL, `userId` VARCHAR(64) NOT NULL, `questionId` VARCHAR(64) NOT NULL, `answer` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`passRecoveryId`));

DROP TABLE IF EXISTS `UserData`;

CREATE TABLE `UserData` ( `userDataId` VARCHAR(64) NOT NULL, `userId` VARCHAR(64) NOT NULL, `password` VARCHAR(512) NOT NULL, `oneTimePassword` VARCHAR(32) NULL DEFAULT NULL, `oneTimePasswordExpiry` INT(11) NULL DEFAULT NULL, `oneTimePasswordGenDate` TIMESTAMP NULL DEFAULT NULL, `last5Passwords` VARCHAR(500) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`userDataId`));

DROP TABLE IF EXISTS `SessionData`;

CREATE TABLE `SessionData` ( `dataId` VARCHAR(256) NOT NULL, `customerId` VARCHAR(64) NULL DEFAULT NULL, `userId` VARCHAR(64) NOT NULL, `sessionKey` VARCHAR(64) NOT NULL, `dataType` INT(10) NOT NULL, `numberValue` INT(10) NULL DEFAULT NULL, `dateTimeValue` TIMESTAMP NULL DEFAULT NULL, `stringValue` VARCHAR(2000) NULL DEFAULT NULL, `booleanValue` TINYINT(1) NULL DEFAULT NULL, `jsonValue` TEXT NULL DEFAULT NULL, `appSessionId` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`dataId`));

DROP TABLE IF EXISTS `Roles`;

CREATE TABLE `Roles` ( `roleId` VARCHAR(64) NOT NULL, `RoleName` VARCHAR(256) NOT NULL, `RoleDescription` VARCHAR(256) NOT NULL, `RoleIcon` VARCHAR(64) NULL DEFAULT NULL, `roleHelp` VARCHAR(256) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`roleId`));
...
CREATE TABLE `RoleMenuBridge` ( `roleMenuMapId` VARCHAR(64) NOT NULL, `roleId` VARCHAR(64) NOT NULL, `menuId` VARCHAR(64) NOT NULL, `isRead` TINYINT(1) NOT NULL, `isWrite` TINYINT(1) NOT NULL, `isExecute` TINYINT(1) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`roleMenuMapId`));

DROP TABLE IF EXISTS `UserRoleBridge`;

CREATE TABLE `UserRoleBridge` ( `roleUserMapId` VARCHAR(64) NOT NULL, `roleId` VARCHAR(64) NOT NULL, `userId` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`roleUserMapId`));

DROP TABLE IF EXISTS `AppCustomerType`;

CREATE TABLE `AppCustomerType` ( `appcustTypeId` VARCHAR(64) NOT NULL, `appCustomerTypeId` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`appcustTypeId`));

DROP TABLE IF EXISTS `AppCustomerCategory`;

CREATE TABLE `AppCustomerCategory` ( `appcustCategoryId` VARCHAR(64) NOT NULL, `customerCategory` VARCHAR(256) NOT NULL, `appCustTypeId` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`appcustCategoryId`));

DROP TABLE IF EXISTS `AppCustomer`;

CREATE TABLE `AppCustomer` ( `appCustomerId` VARCHAR(64) NOT NULL, `contactId` VARCHAR(64) NOT NULL, `customerName` VARCHAR(256) NULL DEFAULT NULL, `startDate` DATE NOT NULL, `endDate` DATE NOT NULL, `customerStatus` INT(10) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`appCustomerId`));

DROP TABLE IF EXISTS `Currency`;

CREATE TABLE `Currency` ( `currencyId` VARCHAR(64) NOT NULL, `countryId` VARCHAR(64) NOT NULL, `currencyCode` VARCHAR(128) NULL DEFAULT NULL, `unicodeDecimal` VARCHAR(128) NULL DEFAULT NULL, `unicodeHex` VARCHAR(128) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`currencyId`));

DROP TABLE IF EXISTS `Region`;

CREATE TABLE `Region` ( `regionId` VARCHAR(64) NOT NULL, `countryId` VARCHAR(64) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `regionName` VARCHAR(256) NOT NULL, `regionCode1` INT(3) NOT NULL, `regionCodeChar2` VARCHAR(32) NOT NULL, `regionDescription` VARCHAR(256) NULL DEFAULT NULL, `regionFlag` VARCHAR(128) NULL DEFAULT NULL, `regionLatitude` INT(11) NULL DEFAULT NULL, `regionLongitude` INT(11) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`regionId`));

DROP TABLE IF EXISTS `District`;

CREATE TABLE `District` ( `districtId` VARCHAR(64) NOT NULL, `countryId` VARCHAR(64) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `regionId` VARCHAR(64) NOT NULL, `Name` VARCHAR(256) NOT NULL, `code2` VARCHAR(32) NOT NULL, `districtDescription` VARCHAR(128) NULL DEFAULT NULL, `districtFlag` VARCHAR(128) NULL DEFAULT NULL, `districtLatitude` INT(11) NULL DEFAULT NULL, `districtLongitude` INT(11) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`districtId`));

DROP TABLE IF EXISTS `Taluka`;

CREATE TABLE `Taluka` ( `talukaId` VARCHAR(64) NOT NULL, `countryId` VARCHAR(64) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `regionId` VARCHAR(64) NOT NULL, `districtId` VARCHAR(64) NOT NULL, `talukaName` VARCHAR(256) NOT NULL, `talukaCode` VARCHAR(32) NOT NULL, `talukaDescription` VARCHAR(128) NULL DEFAULT NULL, `talukaFlag` VARCHAR(128) NULL DEFAULT NULL, `talukaLatitude` INT(11) NULL DEFAULT NULL, `talukaLongitude` INT(11) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`talukaId`));

DROP TABLE IF EXISTS `Village`;

CREATE TABLE `Village` ( `villageId` VARCHAR(64) NOT NULL, `villageName` VARCHAR(256) NOT NULL, `villageDescription` VARCHAR(256) NULL DEFAULT NULL, `villageFlag` VARCHAR(64) NULL DEFAULT NULL, `countryId` VARCHAR(64) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `regionId` VARCHAR(64) NOT NULL, `districtId` VARCHAR(64) NOT NULL, `talukaaId` VARCHAR(64) NOT NULL, `villageCode` VARCHAR(32) NOT NULL, `villageLatitude` VARCHAR(11) NULL DEFAULT NULL, `villageLongtitude` INT(11) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`villageId`));

DROP TABLE IF EXISTS `AddressExtended`;

CREATE TABLE `AddressExtended` ( `addExtId` VARCHAR(64) NOT NULL, `addressId` VARCHAR(64) NOT NULL, `villageId` VARCHAR(64) NULL DEFAULT NULL, `talukaId` VARCHAR(64) NULL DEFAULT NULL, `districtId` VARCHAR(64) NULL DEFAULT NULL, `regionId` VARCHAR(64) NULL DEFAULT NULL, `villageName` VARCHAR(128) NULL DEFAULT NULL, `talukaName` VARCHAR(128) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`addExtId`));

DROP TABLE IF EXISTS `Zones`;

CREATE TABLE `Zones` ( `zoneId` VARCHAR(256) NOT NULL, `zoneName` VARCHAR(256) NOT NULL, `stateId` VARCHAR(64) NOT NULL, `countryId` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`zoneId`));
...
CREATE TABLE `TestA` ( `tid` VARCHAR(256) NOT NULL, `tnm` VARCHAR(256) NOT NULL, `tDate` DATE NOT NULL, `tDateTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`tid`));

DROP TABLE IF EXISTS `AEntity`;

CREATE TABLE `AEntity` ( `aid` VARCHAR(256) NOT NULL, `aNm` VARCHAR(256) NOT NULL, `aDate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`aid`), UNIQUE KEY (`aNm`));

DROP TABLE IF EXISTS `BEntity`;

CREATE TABLE `BEntity` ( `bid` VARCHAR(256) NOT NULL, `bNm` VARCHAR(256) NOT NULL, `bno` INT(10) NOT NULL, `cDate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`bid`), UNIQUE KEY (`bNm`,`bno`));

DROP TABLE IF EXISTS `Passanger`;

CREATE TABLE `Passanger` ( `passangerId` VARCHAR(256) NOT NULL, `passangerName` VARCHAR(256) NOT NULL, `passangerAddr` VARCHAR(64) NOT NULL, `passportNo` VARCHAR(256) NOT NULL, `dob` DATE NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`passangerId`));

DROP TABLE IF EXISTS `ATestEntity`;

CREATE TABLE `ATestEntity` ( `atestentityPkey` INT(11) NOT NULL AUTO_INCREMENT, `aid` VARCHAR(256) NOT NULL, `tid` VARCHAR(256) NOT NULL, PRIMARY KEY (`atestentityPkey`));

DROP TABLE IF EXISTS `Employee`;

CREATE TABLE `Employee` ( `empId` VARCHAR(256) NOT NULL, `empName` VARCHAR(256) NOT NULL, `empsal` DOUBLE(21,2) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`empId`));

DROP TABLE IF EXISTS `Flight`;

CREATE TABLE `Flight` ( `flightId` VARCHAR(256) NOT NULL, `flightName` VARCHAR(256) NOT NULL, `totalSeat` INT(10) NULL DEFAULT NULL, `flySource` VARCHAR(64) NOT NULL, `flyDestination` VARCHAR(64) NULL DEFAULT NULL, `departureDate` DATE NULL DEFAULT NULL, `departureTime` TIME NULL DEFAULT NULL, `fareEconomy` INT(10) NULL DEFAULT NULL, `fareFirst` INT(10) NULL DEFAULT NULL, `bookEcon` INT(10) NULL DEFAULT NULL, `bookFirst` INT(10) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, `multiTenantId` VARCHAR(256) NULL DEFAULT '-1', PRIMARY KEY (`flightId`));
...
ALTER TABLE `AppCustomerCategory` ADD CONSTRAINT FOREIGN KEY (`appCustTypeId`) REFERENCES `AppCustomerType`(`appcustTypeId`);

ALTER TABLE `AppCustomer` ADD CONSTRAINT FOREIGN KEY (`contactId`) REFERENCES `CoreContacts`(`contactId`);

ALTER TABLE `Currency` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `Region` ADD CONSTRAINT FOREIGN KEY (`stateId`) REFERENCES `State`(`stateId`);

ALTER TABLE `Region` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `District` ADD CONSTRAINT FOREIGN KEY (`stateId`) REFERENCES `State`(`stateId`);

ALTER TABLE `District` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `District` ADD CONSTRAINT FOREIGN KEY (`regionId`) REFERENCES `Region`(`regionId`);

ALTER TABLE `Taluka` ADD CONSTRAINT FOREIGN KEY (`stateId`) REFERENCES `State`(`stateId`);

ALTER TABLE `Taluka` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `Taluka` ADD CONSTRAINT FOREIGN KEY (`regionId`) REFERENCES `Region`(`regionId`);

ALTER TABLE `Taluka` ADD CONSTRAINT FOREIGN KEY (`districtId`) REFERENCES `District`(`districtId`);

ALTER TABLE `Village` ADD CONSTRAINT FOREIGN KEY (`stateId`) REFERENCES `State`(`stateId`);

ALTER TABLE `Village` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `Village` ADD CONSTRAINT FOREIGN KEY (`regionId`) REFERENCES `Region`(`regionId`);

ALTER TABLE `Village` ADD CONSTRAINT FOREIGN KEY (`talukaaId`) REFERENCES `Taluka`(`talukaId`);

ALTER TABLE `Village` ADD CONSTRAINT FOREIGN KEY (`districtId`) REFERENCES `District`(`districtId`);

ALTER TABLE `AddressExtended` ADD CONSTRAINT FOREIGN KEY (`addressId`) REFERENCES `Address`(`addressId`);

ALTER TABLE `AddressExtended` ADD CONSTRAINT FOREIGN KEY (`villageId`) REFERENCES `Village`(`villageId`);

ALTER TABLE `AddressExtended` ADD CONSTRAINT FOREIGN KEY (`regionId`) REFERENCES `Region`(`regionId`);

ALTER TABLE `AddressExtended` ADD CONSTRAINT FOREIGN KEY (`talukaId`) REFERENCES `Taluka`(`talukaId`);

ALTER TABLE `AddressExtended` ADD CONSTRAINT FOREIGN KEY (`districtId`) REFERENCES `District`(`districtId`);

ALTER TABLE `Zones` ADD CONSTRAINT FOREIGN KEY (`stateId`) REFERENCES `State`(`stateId`);

ALTER TABLE `Zones` ADD CONSTRAINT FOREIGN KEY (`countryId`) REFERENCES `Country`(`countryId`);

ALTER TABLE `Passanger` ADD CONSTRAINT FOREIGN KEY (`passangerAddr`) REFERENCES `AddressExtended`(`addExtId`);

ALTER TABLE `ATestEntity` ADD CONSTRAINT FOREIGN KEY (`tid`) REFERENCES `TestA`(`tid`);

ALTER TABLE `ATestEntity` ADD CONSTRAINT FOREIGN KEY (`aid`) REFERENCES `AEntity`(`aid`);

ALTER TABLE `Flight` ADD CONSTRAINT FOREIGN KEY (`flyDestination`) REFERENCES `City`(`cityId`);

ALTER TABLE `Flight` ADD CONSTRAINT FOREIGN KEY (`flySource`) REFERENCES `City`(`cityId`);
