Ext.define('Testpro.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testpro.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testpro.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testpro.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testpro.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testpro.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testpro.view.clouddrive.CloudDrive");
    },
