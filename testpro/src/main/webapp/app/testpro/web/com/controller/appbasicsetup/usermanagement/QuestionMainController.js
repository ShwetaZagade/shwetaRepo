Ext.define('Testpro.testpro.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
