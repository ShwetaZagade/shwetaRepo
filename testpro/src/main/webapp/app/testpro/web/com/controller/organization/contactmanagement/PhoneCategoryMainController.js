Ext.define('Testpro.testpro.web.com.controller.organization.contactmanagement.PhoneCategoryMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.organization.contactmanagement.PhoneCategoryModel',
               autoLoad: true,
