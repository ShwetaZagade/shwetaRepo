Ext.define('Testpro.testpro.web.com.controller.organizationextendedbc.locationextended.VillageMainController', {
     ...
     onCountryIdChangeRegionId: function(me, newValue, oldValue, eOpts) {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    ...
                    regionIdCombo.setValue();
                    var responseText = Ext.JSON.decode(response.responseText);
                    regionIdCombo.setComboData(responseText.response.data);
     ...
     onCountryIdChangeTalukaaId: function(me, newValue, oldValue, eOpts) {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    ...
                    talukaaIdCombo.setValue();
                    var responseText = Ext.JSON.decode(response.responseText);
                    talukaaIdCombo.setComboData(responseText.response.data);
