Ext.define('Testpro.testpro.web.com.controller.organizationextendedbc.locationextended.CurrencyMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.organizationextendedbc.locationextended.CurrencyModel',
               autoLoad: true,
