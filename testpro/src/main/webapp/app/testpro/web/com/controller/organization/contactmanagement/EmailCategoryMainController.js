Ext.define('Testpro.testpro.web.com.controller.organization.contactmanagement.EmailCategoryMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.organization.contactmanagement.EmailCategoryModel',
               autoLoad: true,
