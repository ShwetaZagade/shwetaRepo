Ext.define('Testpro.testpro.web.com.controller.appinsight.health.CEntityMainController', {
     extend: 'Testpro.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CEntityMainController',
     init: function() {
          var form = this.view.down('#CEntityForm');
          form.reset();
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#CEntityGrid');
          var tree = this.view.down('#CEntityTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#CEntity');
          var grid = this.view.down('#CEntityGrid');
          var tree = this.view.down('#CEntityTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CEntityForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#CEntityTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var CEntity = this.view.down('#CEntityForm');
               CEntity.reset();
               var gridPanel = this.view.down('#CEntityGrid');
          ...
          var formPanel = this.getView().up().down('#CEntityForm');
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.appinsight.health.CEntityModel',
               autoLoad: true,
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#CEntityTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CEntity').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CEntityGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
