Ext.define('Testpro.testpro.web.com.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: true,
