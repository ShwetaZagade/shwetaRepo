Ext.define('Testpro.testpro.web.com.controller.multitenant.customers.AppCustomerCategoryMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.multitenant.customers.AppCustomerCategoryModel',
               autoLoad: true,
