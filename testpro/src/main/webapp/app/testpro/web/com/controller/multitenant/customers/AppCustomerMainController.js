Ext.define('Testpro.testpro.web.com.controller.multitenant.customers.AppCustomerMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.multitenant.customers.AppCustomerModel',
               autoLoad: true,
