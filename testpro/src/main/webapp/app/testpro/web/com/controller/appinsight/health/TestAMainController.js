Ext.define('Testpro.testpro.web.com.controller.appinsight.health.TestAMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testpro.testpro.shared.com.model.appinsight.health.TestAModel',
               autoLoad: true,
