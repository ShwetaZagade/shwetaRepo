...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "Repository for UserDetail Transaction table", complexity = Complexity.MEDIUM)
public interface UserDetailRepository<T> extends SearchInterface, UserRepositoryInterface {
