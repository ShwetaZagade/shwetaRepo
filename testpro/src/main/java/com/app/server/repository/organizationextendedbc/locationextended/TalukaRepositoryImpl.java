...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "Repository for Taluka Master table Entity", complexity = Complexity.LOW)
public class TalukaRepositoryImpl extends SearchInterfaceImpl implements TalukaRepository<Taluka> {
    ...
    public List<Taluka> findAll() throws Exception {
        ...
        List<Taluka> query = emanager.createNamedQuery("Taluka.findAll").getResultList();
    ...
    /**
     * Saves the list of new <Taluka> object.
     * @return java.util.List<Taluka>
     * @Params list of Taluka
     * @throws java.lang.Exception
     */
    @Transactional
    @Override
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Taluka object = emanager.find(com.app.shared.organizationextendedbc.locationextended.Taluka.class, id);
    ...
    /**
     * Return list of Taluka objects by filtering on refernce key <countryId>
     * @return List<Taluka>
    ...
    public List<Taluka> findByCountryId(String countryId) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Query query = emanager.createNamedQuery("Taluka.findByCountryId");
    ...
    /**
     * Return list of Taluka objects by filtering on refernce key <stateId>
     * @return List<Taluka>
    ...
    public List<Taluka> findByStateId(String stateId) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Query query = emanager.createNamedQuery("Taluka.findByStateId");
    ...
    /**
     * Return list of Taluka objects by filtering on refernce key <regionId>
     * @return List<Taluka>
    ...
    public List<Taluka> findByRegionId(String regionId) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Query query = emanager.createNamedQuery("Taluka.findByRegionId");
    ...
    /**
     * Return list of Taluka objects by filtering on refernce key <districtId>
     * @return List<Taluka>
    ...
    public List<Taluka> findByDistrictId(String districtId) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Query query = emanager.createNamedQuery("Taluka.findByDistrictId");
    ...
    /**
     * Return Taluka object by filtering on refernce key <talukaId>
     * @return Taluka
    ...
    public Taluka findById(String talukaId) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        Query query = emanager.createNamedQuery("Taluka.findById");
        query.setParameter("talukaId", talukaId);
        Taluka listOfTaluka = (Taluka) query.getSingleResult();
