...
public interface PassangerRepository<T> extends SearchInterface {
    ...
    List<T> findByPassangerAddr(String passangerAddr) throws Exception;

    T findById(String passangerId) throws Exception;
}
