...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "Repository for PhoneCommunication Transaction table", complexity = Complexity.MEDIUM)
public class PhoneCommunicationRepositoryImpl extends SearchInterfaceImpl implements PhoneCommunicationRepository<PhoneCommunication> {
    ...
    public List<PhoneCommunication> save(List<PhoneCommunication> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            PhoneCommunication obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        PhoneCommunication object = emanager.find(com.app.shared.organization.contactmanagement.PhoneCommunication.class, id);
