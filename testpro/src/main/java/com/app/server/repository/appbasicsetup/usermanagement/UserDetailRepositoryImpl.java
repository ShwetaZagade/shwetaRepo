...
@Repository
public class UserDetailRepositoryImpl extends SearchInterfaceImpl implements UserDetailRepository<UserDetail> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource(runtimeLogInfoHelper.getMultitenantFields());
        UserDetail object = emanager.find(com.app.shared.appbasicsetup.usermanagement.UserDetail.class, id);
