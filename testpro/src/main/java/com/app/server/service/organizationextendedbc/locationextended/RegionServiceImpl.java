...
public class RegionServiceImpl extends RegionService {
    ...
    /**
     * Retrieve list of  <Region> object
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<Region> lstregion = regionrepo.findAll();
    ...
    /**
     * Saves the new  list of new <Region> object.
     * @return HttpEntity<ResponseBean>
     * @Params entity type:- List<Region>
    ...
    /**
     * Retrieves list of  <Region> object
     * @return HttpEntity<ResponseBean>
    ...
    public HttpEntity<ResponseBean> findByCountryId(@RequestBody FindByBean findByBean) throws Exception {
        List<Region> lstregion = regionrepo.findByCountryId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("OEBLE124100200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Region"));
        responseBean.add("data", lstregion);
        Log.out.println("OEBLE124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "RegionServiceImpl", "findByCountryId", "Region");
        return new ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findByStateId(@RequestBody FindByBean findByBean) throws Exception {
        List<Region> lstregion = regionrepo.findByStateId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("OEBLE124100200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Region"));
        responseBean.add("data", lstregion);
        Log.out.println("OEBLE124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "RegionServiceImpl", "findByStateId", "Region");
        return new ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        Region lstregion = regionrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("OEBLE124100200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Region"));
        responseBean.add("data", lstregion);
        Log.out.println("OEBLE124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "RegionServiceImpl", "findById", "Region");
        return new ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
}
