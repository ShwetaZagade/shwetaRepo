...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "EmailCategory", complexity = Complexity.LOW)
...
public class EmailCategory implements Serializable, CommonEntityInterface, Comparator<EmailCategory> {
    ...
    private static final long serialVersionUID = 1474436550792L;
