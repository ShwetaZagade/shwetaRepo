...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    private static final long serialVersionUID = 1474436545779L;
