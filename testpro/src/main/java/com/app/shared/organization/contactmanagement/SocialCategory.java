...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "SocialCategory", complexity = Complexity.LOW)
...
public class SocialCategory implements Serializable, CommonEntityInterface, Comparator<SocialCategory> {
    ...
    private static final long serialVersionUID = 1474436551648L;
