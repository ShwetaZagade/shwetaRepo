...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    private static final long serialVersionUID = 1474436546425L;
