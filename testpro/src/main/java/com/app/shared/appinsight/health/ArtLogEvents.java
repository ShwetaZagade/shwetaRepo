...
public class ArtLogEvents implements Serializable {
    ...
    public ArtLogEvents(String logeventId, Timestamp eventDateTime, Date eventDate, String alarmId, String multiTenantId, String userId, String userIpAddress, int userPort, double geoLatitude, double geoLongitude, String sessionId, String requestId, String boundedContextId, String domainId, String className, String methodName, String message, String exception, int context, int severity, int layerId, int eventAction, int alarmStatus) {
        super();
    ...
    public String toString() {
        return "ArtLogAlarmEvents [logeventId=" + logeventId + ", eventDateTime=" + eventDateTime + ", eventDate=" + eventDate + ", alarmId=" + alarmId + ", multiTenantId=" + multiTenantId + ", userId=" + userId + ", userIpAddress=" + userIpAddress + ", userPort=" + userPort + ", geoLatitude=" + geoLatitude + ", geoLongitude=" + geoLongitude + ", sessionId=" + sessionId + ", requestId=" + requestId + ", boundedContextId=" + boundedContextId + ", domainId=" + domainId + ", className=" + className + ", methodName=" + methodName + ", message=" + message + ", exception=" + exception + ", context=" + context + ", severity=" + severity + ", layerId=" + layerId + ", eventAction=" + eventAction + ", alarmStatus=" + alarmStatus + "]";
    }
