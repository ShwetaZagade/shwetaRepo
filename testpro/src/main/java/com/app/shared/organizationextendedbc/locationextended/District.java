...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((name == null ? " " : name) + ",").append((code2 == null ? " " : code2));
        return sb.toString();
    }
