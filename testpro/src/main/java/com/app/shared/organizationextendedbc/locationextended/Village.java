...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((villageName == null ? " " : villageName) + ",").append((villageCode == null ? " " : villageCode));
        return sb.toString();
    }
