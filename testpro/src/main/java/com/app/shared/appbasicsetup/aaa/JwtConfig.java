...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "JwtConfig", complexity = Complexity.LOW)
...
public class JwtConfig implements Serializable, CommonEntityInterface, Comparator<JwtConfig> {
    ...
    private static final long serialVersionUID = 1474436572222L;
