...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "UserDetail", complexity = Complexity.LOW)
...
public class UserDetail implements Serializable, CommonEntityInterface, UserInterface, Comparator<UserDetail> {
    ...
    private static final long serialVersionUID = 1474436556338L;
