...
public class EmployeeTestCase extends EntityTestCriteria {
    ...
    private Employee createEmployee(Boolean isSave) throws Exception {
        ...
        employee.setEmpsal(3400.0d);
        employee.setEmpName("FgRIsxugIoBUXXr4BmxIiHt2ojPTU6HzMubnVOCkvlQ83kh2pf");
    ...
    public void test2Update() {
        try {
            ...
            employee.setEmpsal(6860.0d);
            employee.setVersionId(1);
            employee.setEmpName("uQdICf2r6xK9Tz74YqcHebMe29KGvkORBbdJApj7aYS0F4lQD1");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "empName", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 3, "empsal", 1.7709391632162796E19d));
