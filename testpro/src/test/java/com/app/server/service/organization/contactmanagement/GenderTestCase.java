...
public class GenderTestCase extends EntityTestCriteria {
    ...
    private Gender createGender(Boolean isSave) throws Exception {
        ...
        gender.setGender("exyZ5TNrr6od6Q6VAReQOioiOwsiBAe6KzBy2cXooJeBQHTCvJ");
    ...
    public void test2Update() {
        try {
            ...
            gender.setGender("dgKX3nqukjSGdfnHtYYmBfzpDL63uoXXEsSDV7UwOhCwK3dhBg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "gender", ""));
