...
public class AddressTypeTestCase extends EntityTestCriteria {
    ...
    private AddressType createAddressType(Boolean isSave) throws Exception {
        ...
        addresstype.setAddressTypeDesc("cXflqL3gKL9a5KRi4OyzTBiE6QTWykO3jU5O2KK3jKs7txQncl");
        addresstype.setAddressType("hI6nXl60vCW9vLdf5aNdZSGcI1QNJBNCPVyNtl9Yj8vj5gH4Fz");
        addresstype.setAddressTypeIcon("Hg49ZFClNRZuMFjVAcjk2wRRvQMUmMZG7GVyl7IQJxEYfiM5ES");
    ...
    public void test2Update() {
        try {
            ...
            addresstype.setAddressTypeDesc("JOE6YRrepHhOU2LimpOzoBckmVb0V9M6zJDUzzBUxlxiluT2N8");
            addresstype.setVersionId(1);
            addresstype.setAddressType("LG9di0X7F7rWgUUZ8tB704hIIGth3OP17KIf6lAZ4vEtoqeEld");
            addresstype.setAddressTypeIcon("vYEZDJRxs9dPIEzVQgUiMlRQgtFtO08RtIOb9sRI7A4x1hsyJ5");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "addressType", "q028WdQeC9ApREnIH2QWx8tBSUA0cketUhSEQY1q5l0TSuYLTUK5oN6f51VXO5g86rA4uZS2hfQ9A1diE5ZeNn9xBwFWDsBzmPUkxwTj1nOy7InIVgMlCpXzSpuQg8yeA"));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 3, "addressTypeDesc", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "addressTypeIcon", "heHhgIKVnfFSAaMoymHq1BKbCQCK7u6tXgi9Sh6XpDNUP3wkcxovZISenW3ZL1rXZozAGCn9btvf1MIEnOI80lzL1RjvOaOIFfnhClxBz6U5OwymcCkFu80LyTk8ouuAt"));
