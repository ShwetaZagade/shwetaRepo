...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainIcon("gvT3l4vYz3dxxqJSpZu9Snhj4LTKryVT59po4pkjVrB9O7kvbg");
        useraccessdomain.setDomainHelp("7sTnCKRyt2CVd6TjMmlIbUbAgDZDYO2c6iuug70FVkA0Lq8CFb");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("BrhVUtyBe2SEo8jNSqS85f3wuAO2s5cv8Q2SW5agbCeq4nKaJF");
        useraccessdomain.setDomainDescription("B1giVI03tTAlrpIDuGi3fbr1GeDrJhnvdM6H9wUZQQ4R9GXyr8");
        ...
        useraccesslevel.setLevelIcon("w4ihyo8rXGTmrZ5cpXyJFYDyb8GwpiMb3Vbk8CuUwStuGiS2JM");
        useraccesslevel.setLevelHelp("iO5Hp9JlPt56RruK5GdOQ8g2n9ept5e0AzOnh5anZtGTkyauYO");
        useraccesslevel.setLevelName("dcQJqPY4gKcHQjxKbbWpwCqPRFyH3atgcwSA6hWzGy7pIpBogb");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("hEwMCkZExTQsmbz7wn5d8xLWLRxsI4cRc9kaB6qutXt8f2VQCn");
        ...
        User user = new User();
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1474275701622l));
        user.setAllowMultipleLogin(1);
        user.setChangePasswordNextLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setIsDeleted(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1474275701622l));
        user.setGenTempOneTimePassword(1);
        user.setIsLocked(1);
        user.setSessionTimeout(2548);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordAlgo("PK5auNrcwLUnSqTLgSUhoEYvEITcVPkNXEbNWTN3BVwDPK4mt5");
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessCode(34592);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("O3kmO4qY7KjicEMzIxKohag3fk9nMfUpz3Ihj1ygYGWENdQ54R");
        question.setQuestion("WM2XpJYznSiHvekS4xAbhY3HPUW4MtccAcAyzg3uePf5p7WNqk");
        question.setQuestionIcon("pRyrKoqQsUfEXKWop6JwX3GcyXMPmozQ69O05MwMG1gc54cyyr");
        ...
        passrecovery.setAnswer("Pesaw08ndZwPmvlGMkkKgGQNiAXXAcah8k6syYHkz8v7pXNDoM");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordExpiry(8);
        userdata.setPassword("dkbxVCvkuXTQRE33VKzsJHsxMMesdWFtiObAOeczdKCwmtWrdA");
        userdata.setOneTimePasswordExpiry(1);
        userdata.setPassword("3hkOX9dsZwHGG8W3vN3lUEb3oymHUfzC8QDShXvoIrdLhK9Amj");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1474275701985l));
        userdata.setOneTimePassword("FQtIk0Lg8h8wXOLBHSzo43IJwJvtvTca");
        userdata.setLast5Passwords("XEMVVhTmPJAvpfIXuKCL5RhjIBreUyT9i8yHkhGfTVdUzQRYcG");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 119937));
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "MqxEkOIMTLcAhwFk1tLRyZlviDEPUCw5jOzV92FpKRqXq0Lma8FtKlPX9GWsmIieU"));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4132));
