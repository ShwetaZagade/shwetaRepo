...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("AUpkKA5Ouc43VrlBLN0dlqvRcj71nEomhF9t4mTcMvOd72kaml");
        question.setQuestion("GhxpBPeOk1SJ6UXdjxke3jpS7H1WXutBg0lg3f8596CuzLjeq2");
        question.setQuestionIcon("qeczfNW95uyT76E4g8ea2XN1y07zmHUxZzp7dkwyvMfDiTOhwF");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("HE0WblJT9w9bby3vedEiH0Bk62RYGA3pC28oCE81QuF94qa8Qp");
            question.setQuestion("7ErOLFqmKakQTelzR8uXKnnV4vQ4QlKVvZsn18JD1x24Gd2Flt");
            question.setVersionId(1);
            question.setQuestionIcon("5u3AHpNBqBqzuT7NFKepHr3Zna2hictzh2uMnWDKDMk80wqOoo");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 17));
        entityConstraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "MImkRlfIkAHseHxo40q0yHTGl5z1OfH8Fq3w6UzMVD2gIgjT1ycWx5l1YvLxPe37c"));
