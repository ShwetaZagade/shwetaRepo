...
public class EmailCommunicationTestCase extends EntityTestCriteria {
    ...
    private EmailCommunication createEmailCommunication(Boolean isSave) throws Exception {
        ...
        emailcategory.setEmailCatName("JG8dAolhqjW6qeRlGbqjhEbo1SaYkAf90xSgHyUVSgdqULSbRq");
        ...
        emailcommunication.setEmail("UmkntLxqZFoFdpQbYR9IjdaVOXdo5gD3L6ex4exkRz2JkHNf6x");
    ...
    public void test2Update() {
        try {
            ...
            emailcommunication.setEmail("cMdAxKQfc53XOaUFDYqmWh2AXLdJwZRC0WtZfZu9qySe5SkKav");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "email", ""));
