...
public class EmailCategoryTestCase extends EntityTestCriteria {
    ...
    private EmailCategory createEmailCategory(Boolean isSave) throws Exception {
        ...
        emailcategory.setEmailCatName("26AEbZ4qdAj55MnsR0GfmHYWgVyzalmGr4vp8GxAmdRvgzfx2d");
    ...
    public void test2Update() {
        try {
            ...
            emailcategory.setEmailCatName("l5Ir6GIC6UowSoLK1fV64lU2bGt7KYaOw14dIAtncTrhqMUgUI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "emailCatName", ""));
