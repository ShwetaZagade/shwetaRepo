...
public class PhoneCategoryTestCase extends EntityTestCriteria {
    ...
    private PhoneCategory createPhoneCategory(Boolean isSave) throws Exception {
        ...
        phonecategory.setPhoneCatName("lKrhYtItNnLWuMrjh9iwDTP0kGXCGRlvjZxr1icIZsG1G9qI2h");
    ...
    public void test2Update() {
        try {
            ...
            phonecategory.setPhoneCatName("DGDApUcNrAhP4hTwWb6Nxdj5xJ415ovax1pO1jDauuv02qAYqB");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "phoneCatName", ""));
