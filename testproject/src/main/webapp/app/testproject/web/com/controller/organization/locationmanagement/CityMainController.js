Ext.define('Testproject.testproject.web.com.controller.organization.locationmanagement.CityMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testproject.testproject.shared.com.model.organization.locationmanagement.CityModel',
               autoLoad: true,
