Ext.define('Testproject.testproject.web.com.controller.organization.contactmanagement.CoreContactsMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testproject.testproject.shared.com.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: true,
