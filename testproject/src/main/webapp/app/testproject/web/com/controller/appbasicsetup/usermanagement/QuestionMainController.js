Ext.define('Testproject.testproject.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testproject.testproject.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
