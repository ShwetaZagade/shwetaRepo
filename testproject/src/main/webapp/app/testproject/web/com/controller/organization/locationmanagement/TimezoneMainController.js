Ext.define('Testproject.testproject.web.com.controller.organization.locationmanagement.TimezoneMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Testproject.testproject.shared.com.model.organization.locationmanagement.TimezoneModel',
               autoLoad: true,
