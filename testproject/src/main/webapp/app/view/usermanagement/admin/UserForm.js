Ext.define('Testproject.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Testproject.model.AddUserDataModel' ],
