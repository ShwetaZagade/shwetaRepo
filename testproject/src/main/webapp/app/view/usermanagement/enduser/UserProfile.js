Ext.define('Testproject.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testproject.view.usermanagement.enduser.UserProfileController', 'Testproject.view.usermanagement.admin.AddUserDetailsViewModel', 'Testproject.model.AddUserDataModel' ],
