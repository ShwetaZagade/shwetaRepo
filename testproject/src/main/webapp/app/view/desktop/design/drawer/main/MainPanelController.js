Ext.define('Testproject.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testproject.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testproject.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testproject.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testproject.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testproject.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testproject.view.clouddrive.CloudDrive");
    },
