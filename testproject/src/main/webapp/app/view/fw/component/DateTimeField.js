 ...
 */
Ext.define('Testproject.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testproject.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testproject.view.fw.component.DateTimePicker(o);
    },
