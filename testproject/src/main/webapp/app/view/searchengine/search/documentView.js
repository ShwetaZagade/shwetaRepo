Ext
		.define(
				'Testproject.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testproject.view.searchengine.search.documentController',
							'Testproject.view.searchengine.search.RowExpander' ],
