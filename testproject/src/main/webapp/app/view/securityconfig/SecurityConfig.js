 ...
 * 
 */
Ext.define('Testproject.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testproject.view.securityconfig.SecurityConfigController',
			'Testproject.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
