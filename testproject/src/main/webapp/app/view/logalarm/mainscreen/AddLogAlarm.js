 ...
 * 
 */
Ext.define('Testproject.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testproject.view.logalarm.mainscreen.AddLogAlarmController',
			'Testproject.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testproject.view.logalarm.mainscreen.AppAlarmPanel',
