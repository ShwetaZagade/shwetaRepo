 ...
 * 
 */
Ext.define('Testproject.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testproject.view.logalarm.LogAlarmMainViewController',
			'Testproject.view.logalarm.tree.LogAlarmTreePanel',
			'Testproject.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
