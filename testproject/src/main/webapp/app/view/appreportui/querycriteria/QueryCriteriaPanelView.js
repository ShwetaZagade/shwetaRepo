Ext.define('Testproject.view.appreportui.querycriteria.QueryCriteriaPanelView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Testproject.view.appreportui.querycriteria.QueryCriteriaViewController' ],
