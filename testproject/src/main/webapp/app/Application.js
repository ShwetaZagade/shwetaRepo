...
Ext.define('Testproject.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Testproject.view.databrowsercalendar.DBCalendar",
			"Testproject.view.fw.component.CustomComboBox" ,"Testproject.view.fw.component.TreeComponent"],
	...
	stores : [ 'Testproject.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Testproject.view.login.SessionLogin').center();
