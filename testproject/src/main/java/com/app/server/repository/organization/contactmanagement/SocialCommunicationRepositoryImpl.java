...
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "Repository for SocialCommunication Transaction table", complexity = Complexity.MEDIUM)
public class SocialCommunicationRepositoryImpl extends SearchInterfaceImpl implements SocialCommunicationRepository<SocialCommunication> {
    ...
    public List<SocialCommunication> save(List<SocialCommunication> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            SocialCommunication obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        SocialCommunication object = emanager.find(com.app.shared.organization.contactmanagement.SocialCommunication.class, id);
