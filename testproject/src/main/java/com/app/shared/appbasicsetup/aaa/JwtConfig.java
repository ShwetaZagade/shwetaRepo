...
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "JwtConfig", complexity = Complexity.LOW)
...
public class JwtConfig implements Serializable, CommonEntityInterface, Comparator<JwtConfig> {
    ...
    private static final long serialVersionUID = 1474275708296L;
