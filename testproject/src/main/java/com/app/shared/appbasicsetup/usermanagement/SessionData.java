...
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "SessionData", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "SessionData.FindByAppSessionId", query = "select e from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId"), @javax.persistence.NamedQuery(name = "SessionData.FindBySessionKey", query = "select e from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId and e.sessionKey =:sessionKey"), @javax.persistence.NamedQuery(name = "SessionData.DeleteAllSessionData", query = "delete from SessionData e where e.systemInfo.activeStatus=1 and e.appSessionId=:appSessionId") })
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {

    private static final long serialVersionUID = 1474275705750L;
