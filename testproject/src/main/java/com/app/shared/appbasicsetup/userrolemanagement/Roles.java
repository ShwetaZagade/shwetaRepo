...
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    private static final long serialVersionUID = 1474275705954L;
