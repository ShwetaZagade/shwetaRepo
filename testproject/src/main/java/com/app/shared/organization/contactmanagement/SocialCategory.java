...
@Table(name = "ast_SocialCategory_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "SocialCategory", complexity = Complexity.LOW)
...
public class SocialCategory implements Serializable, CommonEntityInterface, Comparator<SocialCategory> {
    ...
    private static final long serialVersionUID = 1474275696992L;
