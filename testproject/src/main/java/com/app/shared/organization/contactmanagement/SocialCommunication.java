...
@Table(name = "ast_SocialCommunication_T")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "SocialCommunication", complexity = Complexity.LOW)
...
public class SocialCommunication implements Serializable, CommonEntityInterface, Comparator<SocialCommunication> {
    ...
    private static final long serialVersionUID = 1474275698727L;
