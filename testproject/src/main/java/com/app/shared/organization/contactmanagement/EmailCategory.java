...
@Table(name = "ast_EmailCategory_M")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "shubhangi.mane@algorhythm.co.in", updatedBy = "shubhangi.mane@algorhythm.co.in", versionNumber = "3", comments = "EmailCategory", complexity = Complexity.LOW)
...
public class EmailCategory implements Serializable, CommonEntityInterface, Comparator<EmailCategory> {
    ...
    private static final long serialVersionUID = 1474275696154L;
    ...
    public void setEmailCatName(String _emailCatName) {
        if (_emailCatName != null) {
            this.emailCatName = _emailCatName;
        }
    }
    ...
    public void setEmailCatId(String _emailCatId) {
        this.emailCatId = _emailCatId;
    }
