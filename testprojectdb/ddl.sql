...
CREATE TABLE `ast_Emp_T` ( `empNo` INT(10) NOT NULL, `empId` VARCHAR(256) NOT NULL, `empNm` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`empId`));

DROP TABLE IF EXISTS `ast_EmpDEpt_TP`;

CREATE TABLE `ast_EmpDEpt_TP` ( `empId` VARCHAR(256) NOT NULL, `deptId` VARCHAR(256) NOT NULL, `dept` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`deptId`));
...
ALTER TABLE `ast_EmailCommunication_T` ADD CONSTRAINT FOREIGN KEY (`commType`) REFERENCES `ast_EmailCategory_M`(`emailCatId`);

ALTER TABLE `ast_PhoneCommunication_T` ADD CONSTRAINT FOREIGN KEY (`commType`) REFERENCES `ast_PhoneCategory_M`(`phoneCatId`);

ALTER TABLE `ast_SocialCommunication_T` ADD CONSTRAINT FOREIGN KEY (`commType`) REFERENCES `ast_SocialCategory_M`(`socialCatId`);

ALTER TABLE `ast_EmailContactMap_B` ADD CONSTRAINT FOREIGN KEY (`contactId`) REFERENCES `ast_CoreContacts_T`(`contactId`);

ALTER TABLE `ast_EmailContactMap_B` ADD CONSTRAINT FOREIGN KEY (`emailCommId`) REFERENCES `ast_EmailCommunication_T`(`emailCommId`);

ALTER TABLE `ast_PhoneContactMap_B` ADD CONSTRAINT FOREIGN KEY (`contactId`) REFERENCES `ast_CoreContacts_T`(`contactId`);

ALTER TABLE `ast_PhoneContactMap_B` ADD CONSTRAINT FOREIGN KEY (`phoneId`) REFERENCES `ast_PhoneCommunication_T`(`phoneId`);

ALTER TABLE `ast_SocialContactMap_B` ADD CONSTRAINT FOREIGN KEY (`contactId`) REFERENCES `ast_CoreContacts_T`(`contactId`);

ALTER TABLE `ast_SocialContactMap_B` ADD CONSTRAINT FOREIGN KEY (`socialId`) REFERENCES `ast_SocialCommunication_T`(`socialId`);
...
ALTER TABLE `ast_EmpDEpt_TP` ADD CONSTRAINT FOREIGN KEY (`empId`) REFERENCES `ast_Emp_T`(`empId`);
